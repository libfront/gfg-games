(function(scope) {
    ...
    ! function(r) {
        ...
        for (var n = CryptoJS, t = (s = n.lib).WordArray, i = s.Hasher, s = n.algo, a = [], f = [], o = 2, u = 0; u < 64;) {
            var d;
            e: {
                d = o;
                for (var c = r.sqrt(d), l = 2; l <= c; l++)
                    if (!(d % l)) {
                        d = !1;
                        break e
                    }
            ...
            d && (u < 8 && (a[u] = e(r.pow(o, .5))), f[u] = e(r.pow(o, 1 / 3)), u++), o++
        }
        var m = [];
        s = s.SHA256 = i.extend({
            _doReset: function() {
            ...
            _doProcessBlock: function(e, n) {
                for (var t = this._hash.words, i = t[0], r = t[1], s = t[2], a = t[3], o = t[4], u = t[5], d = t[6], c = t[7], l = 0; l < 64; l++) {
                    if (l < 16) m[l] = 0 | e[n + l];
                    else {
                        var v = m[l - 15],
                            g = m[l - 2];
                    ...
                    v = c + ((o << 26 | o >>> 6) ^ (o << 21 | o >>> 11) ^ (o << 7 | o >>> 25)) + (o & u ^ ~o & d) + f[l] + m[l], g = ((i << 30 | i >>> 2) ^ (i << 19 | i >>> 13) ^ (i << 10 | i >>> 22)) + (i & r ^ i & s ^ r & s), c = d, d = u, u = o, o = a + v | 0, a = s, s = r, r = i, i = v + g | 0
                }
                t[0] = t[0] + i | 0, t[1] = t[1] + r | 0, t[2] = t[2] + s | 0, t[3] = t[3] + a | 0, t[4] = t[4] + o | 0, t[5] = t[5] + u | 0, t[6] = t[6] + d | 0, t[7] = t[7] + c | 0
            },
    ...
    function() {
        var d = CryptoJS.enc.Utf8;
        CryptoJS.algo.HMAC = CryptoJS.lib.Base.extend({
            init: function(e, n) {
                e = this._hasher = new e.init, "string" == typeof n && (n = d.parse(n));
                var t = e.blockSize,
                    i = 4 * t;
                n.sigBytes > i && (n = e.finalize(n)), n.clamp();
                for (var r = this._oKey = n.clone(), s = this._iKey = n.clone(), a = r.words, o = s.words, u = 0; u < t; u++) a[u] ^= 1549556828, o[u] ^= 909522486;
    ...
    function(e) {
        ...
        function c() {}
        n = e.utilities || (e.utilities = {}), d = e.logging.GALogger, c.getHmac = function(e, n) {
            ...
            e = encodeURI(e);
            for (var n, t, i, r, s, a = "", o = 0, u = 0, d = 0; i = (n = e.charCodeAt(d++)) >> 2, r = (3 & n) << 4 | (t = e.charCodeAt(d++)) >> 4, s = (15 & t) << 2 | (o = e.charCodeAt(d++)) >> 6, u = 63 & o, isNaN(t) ? s = u = 64 : isNaN(o) && (u = 64), a = a + c.keyStr.charAt(i) + c.keyStr.charAt(r) + c.keyStr.charAt(s) + c.keyStr.charAt(u), n = t = o = 0, i = r = s = u = 0, d < e.length;);
            return a
            ...
            var n, t, i, r, s = "",
                ...
                o = 0,
                u = 0;
            for (/[^A-Za-z0-9\+\/\=]/g.exec(e) && d.w("There were invalid base64 characters in the input text. Valid base64 characters are A-Z, a-z, 0-9, '+', '/',and '='. Expect errors in decoding."), e = e.replace(/[^A-Za-z0-9\+\/\=]/g, ""); n = c.keyStr.indexOf(e.charAt(u++)) << 2 | (i = c.keyStr.indexOf(e.charAt(u++))) >> 4, t = (15 & i) << 4 | (r = c.keyStr.indexOf(e.charAt(u++))) >> 2, a = (3 & r) << 6 | (o = c.keyStr.indexOf(e.charAt(u++))), s += String.fromCharCode(n), 64 != r && (s += String.fromCharCode(t)), 64 != o && (s += String.fromCharCode(a)), n = t = a = 0, i = r = o = 0, u < e.length;);
            return decodeURI(s)
    ...
    function(m) {
        ! function(e) {
            var u = m.logging.GALogger,
                o = m.utilities.GAUtilities,
                d = m.events.EGASdkErrorCategory,
            ...
            var n = (f.validateBusinessEvent = function(e, n, t, i, r) {
                return f.validateCurrency(e) ? n < 0 ? (u.w("Validation fail - business event - amount. Cannot be less than 0. Failed amount: " + n), new g(d.EventValidation, c.BusinessEvent, l.InvalidAmount, v.Amount, n + "")) : f.validateShortString(t, !0) ? f.validateEventPartLength(i, !1) ? f.validateEventPartCharacters(i) ? f.validateEventPartLength(r, !1) ? f.validateEventPartCharacters(r) ? null : (u.w("Validation fail - business event - itemId: Cannot contain other characters than A-z, 0-9, -_., ()!?. String: " + r), new g(d.EventValidation, c.BusinessEvent, l.InvalidEventPartCharacters, v.ItemId, r)) : (u.w("Validation fail - business event - itemId. Cannot be (null), empty or above 64 characters. String: " + r), new g(d.EventValidation, c.BusinessEvent, l.InvalidEventPartLength, v.ItemId, r)) : (u.w("Validation fail - business event - itemType: Cannot contain other characters than A-z, 0-9, -_., ()!?. String: " + i), new g(d.EventValidation, c.BusinessEvent, l.InvalidEventPartCharacters, v.ItemType, i)) : (u.w("Validation fail - business event - itemType: Cannot be (null), empty or above 64 characters. String: " + i), new g(d.EventValidation, c.BusinessEvent, l.InvalidEventPartLength, v.ItemType, i)) : (u.w("Validation fail - business event - cartType. Cannot be above 32 length. String: " + t), new g(d.EventValidation, c.BusinessEvent, l.InvalidShortString, v.CartType, t)) : (u.w("Validation fail - business event - currency: Cannot be (null) and need to be A-Z, 3 characters and in the standard at openexchangerates.org. Failed currency: " + e), new g(d.EventValidation, c.BusinessEvent, l.InvalidCurrency, v.Currency, e))
            }, f.validateResourceEvent = function(e, n, t, i, r, s, a) {
                return e == m.EGAResourceFlowType.Undefined ? (u.w("Validation fail - resource event - flowType: Invalid flow type."), new g(d.EventValidation, c.ResourceEvent, l.InvalidFlowType, v.FlowType, "")) : n ? o.stringArrayContainsString(s, n) ? 0 < t ? i ? f.validateEventPartLength(i, !1) ? f.validateEventPartCharacters(i) ? o.stringArrayContainsString(a, i) ? f.validateEventPartLength(r, !1) ? f.validateEventPartCharacters(r) ? null : (u.w("Validation fail - resource event - itemId: Cannot contain other characters than A-z, 0-9, -_., ()!?. String: " + r), new g(d.EventValidation, c.ResourceEvent, l.InvalidEventPartCharacters, v.ItemId, r)) : (u.w("Validation fail - resource event - itemId: Cannot be (null), empty or above 64 characters. String: " + r), new g(d.EventValidation, c.ResourceEvent, l.InvalidEventPartLength, v.ItemId, r)) : (u.w("Validation fail - resource event - itemType: Not found in list of pre-defined available resource itemTypes. String: " + i), new g(d.EventValidation, c.ResourceEvent, l.NotFoundInAvailableItemTypes, v.ItemType, i)) : (u.w("Validation fail - resource event - itemType: Cannot contain other characters than A-z, 0-9, -_., ()!?. String: " + i), new g(d.EventValidation, c.ResourceEvent, l.InvalidEventPartCharacters, v.ItemType, i)) : (u.w("Validation fail - resource event - itemType: Cannot be (null), empty or above 64 characters. String: " + i), new g(d.EventValidation, c.ResourceEvent, l.InvalidEventPartLength, v.ItemType, i)) : (u.w("Validation fail - resource event - itemType: Cannot be (null)"), new g(d.EventValidation, c.ResourceEvent, l.StringEmptyOrNull, v.ItemType, "")) : (u.w("Validation fail - resource event - amount: Float amount cannot be 0 or negative. Value: " + t), new g(d.EventValidation, c.ResourceEvent, l.InvalidAmount, v.Amount, t + "")) : (u.w("Validation fail - resource event - currency: Not found in list of pre-defined available resource currencies. String: " + n), new g(d.EventValidation, c.ResourceEvent, l.NotFoundInAvailableCurrencies, v.Currency, n)) : (u.w("Validation fail - resource event - currency: Cannot be (null)"), new g(d.EventValidation, c.ResourceEvent, l.StringEmptyOrNull, v.Currency, ""))
            }, f.validateProgressionEvent = function(e, n, t, i) {
                if (e == m.EGAProgressionStatus.Undefined) return u.w("Validation fail - progression event: Invalid progression status."), new g(d.EventValidation, c.ProgressionEvent, l.InvalidProgressionStatus, v.ProgressionStatus, "");
                if (i && !t && n) return u.w("Validation fail - progression event: 03 found but 01+02 are invalid. Progression must be set as either 01, 01+02 or 01+02+03."), new g(d.EventValidation, c.ProgressionEvent, l.WrongProgressionOrder, v.Undefined, n + ":" + t + ":" + i);
                if (t && !n) return u.w("Validation fail - progression event: 02 found but not 01. Progression must be set as either 01, 01+02 or 01+02+03"), new g(d.EventValidation, c.ProgressionEvent, l.WrongProgressionOrder, v.Undefined, n + ":" + t + ":" + i);
                if (!n) return u.w("Validation fail - progression event: progression01 not valid. Progressions must be set as either 01, 01+02 or 01+02+03"), new g(d.EventValidation, c.ProgressionEvent, l.WrongProgressionOrder, v.Undefined, (n || "") + ":" + (t || "") + ":" + (i || ""));
                if (!f.validateEventPartLength(n, !1)) return u.w("Validation fail - progression event - progression01: Cannot be (null), empty or above 64 characters. String: " + n), new g(d.EventValidation, c.ProgressionEvent, l.InvalidEventPartLength, v.Progression01, n);
                if (!f.validateEventPartCharacters(n)) return u.w("Validation fail - progression event - progression01: Cannot contain other characters than A-z, 0-9, -_., ()!?. String: " + n), new g(d.EventValidation, c.ProgressionEvent, l.InvalidEventPartCharacters, v.Progression01, n);
                if (t) {
                    if (!f.validateEventPartLength(t, !0)) return u.w("Validation fail - progression event - progression02: Cannot be empty or above 64 characters. String: " + t), new g(d.EventValidation, c.ProgressionEvent, l.InvalidEventPartLength, v.Progression02, t);
                    if (!f.validateEventPartCharacters(t)) return u.w("Validation fail - progression event - progression02: Cannot contain other characters than A-z, 0-9, -_., ()!?. String: " + t), new g(d.EventValidation, c.ProgressionEvent, l.InvalidEventPartCharacters, v.Progression02, t)
                }
                if (i) {
                    if (!f.validateEventPartLength(i, !0)) return u.w("Validation fail - progression event - progression03: Cannot be empty or above 64 characters. String: " + i), new g(d.EventValidation, c.ProgressionEvent, l.InvalidEventPartLength, v.Progression03, i);
                    if (!f.validateEventPartCharacters(i)) return u.w("Validation fail - progression event - progression03: Cannot contain other characters than A-z, 0-9, -_., ()!?. String: " + i), new g(d.EventValidation, c.ProgressionEvent, l.InvalidEventPartCharacters, v.Progression03, i)
                }
                return null
            }, f.validateDesignEvent = function(e) {
                return f.validateEventIdLength(e) ? f.validateEventIdCharacters(e) ? null : (u.w("Validation fail - design event - eventId: Non valid characters. Only allowed A-z, 0-9, -_., ()!?. String: " + e), new g(d.EventValidation, c.DesignEvent, l.InvalidEventIdCharacters, v.EventId, e)) : (u.w("Validation fail - design event - eventId: Cannot be (null) or empty. Only 5 event parts allowed seperated by :. Each part need to be 32 characters or less. String: " + e), new g(d.EventValidation, c.DesignEvent, l.InvalidEventIdLength, v.EventId, e))
            }, f.validateErrorEvent = function(e, n) {
                return e == m.EGAErrorSeverity.Undefined ? (u.w("Validation fail - error event - severity: Severity was unsupported value."), new g(d.EventValidation, c.ErrorEvent, l.InvalidSeverity, v.Severity, "")) : f.validateLongString(n, !0) ? null : (u.w("Validation fail - error event - message: Message cannot be above 8192 characters."), new g(d.EventValidation, c.ErrorEvent, l.InvalidLongString, v.Message, n))
            }, f.validateSdkErrorEvent = function(e, n, t, i, r) {
                return !(!f.validateKeys(e, n) || (t === d.Undefined ? (u.w("Validation fail - sdk error event - type: Category was unsupported value."), 1) : i === c.Undefined ? (u.w("Validation fail - sdk error event - type: Area was unsupported value."), 1) : r === l.Undefined && (u.w("Validation fail - sdk error event - type: Action was unsupported value."), 1)))
                ...
                if (null == n) return u.w("validateInitRequestResponse failed - no response dictionary."), null;
                var t = {};
                try {
                    var i = n.server_ts;
                    if (!(0 < i)) return u.w("validateInitRequestResponse failed - invalid value in 'server_ts' field."), null;
                    t.server_ts = i
                } catch (e) {
                    return u.w("validateInitRequestResponse failed - invalid type in 'server_ts' field. type=" + typeof n.server_ts + ", value=" + n.server_ts + ", " + e), null
                }
                if (e) {
                    try {
                        var r = n.configs;
                        ...
                        return u.w("validateInitRequestResponse failed - invalid type in 'configs' field. type=" + typeof n.configs + ", value=" + n.configs + ", " + e), null
                    }
                    try {
                        var s = n.configs_hash;
                        t.configs_hash = s
                    } catch (e) {
                        return u.w("validateInitRequestResponse failed - invalid type in 'configs_hash' field. type=" + typeof n.configs_hash + ", value=" + n.configs_hash + ", " + e), null
                    }
                    try {
                        var a = n.ab_id;
                        t.ab_id = a
                    } catch (e) {
                        return u.w("validateInitRequestResponse failed - invalid type in 'ab_id' field. type=" + typeof n.ab_id + ", value=" + n.ab_id + ", " + e), null
                    }
                    try {
                        var o = n.ab_variant_id;
                        t.ab_variant_id = o
                    } catch (e) {
                        return u.w("validateInitRequestResponse failed - invalid type in 'ab_variant_id' field. type=" + typeof n.ab_variant_id + ", value=" + n.ab_variant_id + ", " + e), null
                    }
                }
                return t
                ...
                return !!f.validateString(e, !1) || (u.w("Validation fail - user id: id cannot be (null), empty or above 64 characters."), !1)
                ...
                for (var n = 0; n < e.length; ++n)
                    if (!o.stringMatch(e[n], /^[A-Za-z]+$/)) return u.w("resource currencies validation failed: a resource currency can only be A-Z, a-z. String was: " + e[n]), !1;
                return !0
            }, f.validateResourceItemTypes = function(e) {
                if (!f.validateArrayOfStrings(20, 32, !1, "resource item types", e)) return !1;
                for (var n = 0; n < e.length; ++n)
                    if (!f.validateEventPartCharacters(e[n])) return u.w("resource item types validation failed: a resource item type cannot contain other characters than A-z, 0-9, -_., ()!?. String was: " + e[n]), !1;
                return !0
                ...
                var s = i;
                if (s = s || "Array", !r) return u.w(s + " validation failed: array cannot be null. "), !1;
                if (0 == t && 0 == r.length) return u.w(s + " validation failed: array cannot be empty. "), !1;
                if (0 < e && r.length > e) return u.w(s + " validation failed: array cannot exceed " + e + " values. It has " + r.length + " values."), !1;
                for (var a = 0; a < r.length; ++a) {
                    var o = r[a] ? r[a].length : 0;
                    if (0 === o) return u.w(s + " validation failed: contained an empty string. Array=" + JSON.stringify(r)), !1;
                    if (0 < n && n < o) return u.w(s + " validation failed: a string exceeded max allowed length (which is: " + n + "). String was: " + r[a]), !1
                }
                return !0
                ...
                for (o = 0; o < n.length; o += 1)
                    if (new RegExp(n[o].value, "i").test(e)) {
                        if (t = new RegExp(n[o].version + "[- /:;]([\\d._]+)", "i"), s = "", (i = e.match(t)) && i[1] && (r = i[1]), r) {
                            var d = r.split(/[._]+/);
                            for (u = 0; u < Math.min(d.length, 3); u += 1) s += d[u] + (u < Math.min(d.length, 3) - 1 ? "." : "")
                        } else s = "0.0.0";
        ...
        ! function(e) {
            ...
            var s = (v.isStorageAvailable = function() {
                ...
                for (var s = [], a = 0; a < r.length; ++a) {
                    for (var o = r[a], u = !0, d = 0; d < n.length; ++d) {
                        var c = n[d];
                        if (o[c[0]]) switch (c[1]) {
                            case l.Equal:
                                u = o[c[0]] == c[2];
    ...
    function(e) {
        ...
        n = e.state || (e.state = {}), r = e.validators.GAValidator, u = e.utilities.GAUtilities, d = e.logging.GALogger, o = e.store.GAStore, s = e.device.GADevice, c = e.store.EGAStore, t = e.store.EGAStoreArgsOperator, l.setUserId = function(e) {
            ...
            r.validateCustomDimensions(e) && (l.instance.availableCustomDimensions01 = e, l.validateAndFixCurrentDimensions(), d.i("Set available custom01 dimension values: (" + u.joinStringArray(e, ", ") + ")"))
            ...
            r.validateCustomDimensions(e) && (l.instance.availableCustomDimensions02 = e, l.validateAndFixCurrentDimensions(), d.i("Set available custom02 dimension values: (" + u.joinStringArray(e, ", ") + ")"))
            ...
            r.validateCustomDimensions(e) && (l.instance.availableCustomDimensions03 = e, l.validateAndFixCurrentDimensions(), d.i("Set available custom03 dimension values: (" + u.joinStringArray(e, ", ") + ")"))
            ...
            r.validateResourceCurrencies(e) && (l.instance.availableResourceCurrencies = e, d.i("Set available resource currencies: (" + u.joinStringArray(e, ", ") + ")"))
            ...
            r.validateResourceItemTypes(e) && (l.instance.availableResourceItemTypes = e, d.i("Set available resource item types: (" + u.joinStringArray(e, ", ") + ")"))
        }, l.getBuild = function() {
            return l.instance.build
        }, l.setBuild = function(e) {
            l.instance.build = e, d.i("Set build version: " + e)
            ...
            l.instance.currentCustomDimension01 = e, o.setItem(l.getGameKey(), l.Dimension01Key, e), d.i("Set custom01 dimension value: " + e)
        }, l.setCustomDimension02 = function(e) {
            l.instance.currentCustomDimension02 = e, o.setItem(l.getGameKey(), l.Dimension02Key, e), d.i("Set custom02 dimension value: " + e)
        }, l.setCustomDimension03 = function(e) {
            l.instance.currentCustomDimension03 = e, o.setItem(l.getGameKey(), l.Dimension03Key, e), d.i("Set custom03 dimension value: " + e)
            ...
            l.instance.useManualSessionHandling = e, d.i("Use manual session handling: " + e)
            ...
            return e - u.timeIntervalSince1970()
                ...
                for (var i in e) {
                    ...
                    if (i && r)
                        if (t < l.MAX_CUSTOM_FIELDS_COUNT) {
                            ...
                            if (u.stringMatch(i, s)) {
                                var a = typeof r;
                                if ("string" == a || r instanceof String) r.length <= l.MAX_CUSTOM_FIELDS_VALUE_STRING_LENGTH && 0 < r.length ? (n[i] = r, ++t) : d.w("validateAndCleanCustomFields: entry with key=" + i + ", value=" + r + " has been omitted because its value is an empty string or exceeds the max number of characters (" + l.MAX_CUSTOM_FIELDS_VALUE_STRING_LENGTH + ")");
                                else if ("number" == a || r instanceof Number) {
                                    var o = r;
                                    n[i] = o, ++t
                                } else d.w("validateAndCleanCustomFields: entry with key=" + i + ", value=" + r + " has been omitted because its value is not a string or number")
                            } else d.w("validateAndCleanCustomFields: entry with key=" + i + ", value=" + r + " has been omitted because its key contains illegal character, is empty or exceeds the max number of characters (" + l.MAX_CUSTOM_FIELDS_KEY_LENGTH + ")")
                        } else d.w("validateAndCleanCustomFields: entry with key=" + i + ", value=" + r + " has been omitted because it exceeds the max number of custom fields (" + l.MAX_CUSTOM_FIELDS_COUNT + ")");
                    else d.w("validateAndCleanCustomFields: entry with key=" + i + ", value=" + r + " has been omitted because its key or value is null")
                }
            }
            return n
                ...
                for (var t = 0; t < n.length; ++t) {
                    ...
                    if (i) {
                        var r = i.key,
                            ...
                            u = l.getClientTsAdjusted();
                        r && s && a < u && u < o && (l.instance.configurations[r] = s)
                    }
                }
            }
            l.instance.remoteConfigsIsReady = !0;
            var d = l.instance.remoteConfigsListeners;
            for (t = 0; t < d.length; ++t) d[t] && d[t].onRemoteConfigsUpdated()
    ...
    function(e) {
        ...
        function d() {}
        n = e.tasks || (e.tasks = {}), o = e.utilities.GAUtilities, u = e.logging.GALogger, d.execute = function(e, n, t, i) {
            var r = new Date;
            if (d.timestampMap[n] || (d.timestampMap[n] = r), d.countMap[n] || (d.countMap[n] = 0), 3600 <= (r.getTime() - d.timestampMap[n].getTime()) / 1e3 && (d.timestampMap[n] = r, d.countMap[n] = 0), !(d.countMap[n] >= d.MaxCount)) {
                var s = o.getHmac(i, t),
                    a = new XMLHttpRequest;
                a.onreadystatechange = function() {
                    if (4 === a.readyState) {
                        if (!a.responseText) return;
                        if (200 != a.status) return void u.w("sdk error failed. response code not 200. status code: " + a.status + ", description: " + a.statusText + ", body: " + a.responseText);
                        d.countMap[n] = d.countMap[n] + 1
                    }
        ...
        }, d.MaxCount = 10, d.countMap = {}, d.timestampMap = {}, t = d, n.SdkErrorTask = t
    }(gameanalytics = gameanalytics || {}),
    function(e) {
        var c, E, S, l, h, y, v, g, f, m, n;

        function A() {
            this.protocol = "https", this.hostName = "api.gameanalytics.com", this.version = "v2", this.remoteConfigsVersion = "v1", this.baseUrl = this.protocol + "://" + this.hostName + "/" + this.version, this.remoteConfigsBaseUrl = this.protocol + "://" + this.hostName + "/remote_configs/" + this.remoteConfigsVersion, this.initializeUrlPath = "init", this.eventsUrlPath = "events", this.useGzip = !1
        }
        c = e.http || (e.http = {}), E = e.state.GAState, S = e.logging.GALogger, l = e.utilities.GAUtilities, h = e.validators.GAValidator, y = e.tasks.SdkErrorTask, v = e.events.EGASdkErrorCategory, g = e.events.EGASdkErrorArea, f = e.events.EGASdkErrorAction, m = e.events.EGASdkErrorParameter, A.prototype.requestInit = function(e, n) {
            var t = E.getGameKey(),
                i = this.remoteConfigsBaseUrl + "/" + this.initializeUrlPath + "?game_key=" + t + "&interval_seconds=0&configs_hash=" + e,
                r = E.getInitAnnotations(),
                s = JSON.stringify(r);
            if (s) {
                var a = this.createPayloadData(s, this.useGzip),
                    o = [];
                o.push(s), A.sendRequest(i, a, o, this.useGzip, A.initRequestCallback, n)
            } else n(c.EGAHTTPApiResponse.JsonEncodeFailed, null)
        }, A.prototype.sendEventsInArray = function(e, n, t) {
            if (0 != e.length) {
                var i = E.getGameKey(),
                ...
                if (s) {
                    var a = this.createPayloadData(s, this.useGzip),
                        o = [];
                    o.push(s), o.push(n), o.push(e.length.toString()), A.sendRequest(r, a, o, this.useGzip, A.sendEventInArrayRequestCallback, t)
                } else t(c.EGAHTTPApiResponse.JsonEncodeFailed, null, n, e.length)
            }
        }, A.prototype.sendSdkErrorEvent = function(e, n, t, i, r, s, a) {
            if (E.isEventSubmissionEnabled() && h.validateSdkErrorEvent(s, a, e, n, t)) {
                var o, u = this.baseUrl + "/" + s + "/" + this.eventsUrlPath,
                    d = "",
                    c = E.getSdkErrorEventAnnotations(),
                    l = A.sdkErrorCategoryString(e);
                d += c.error_category = l;
                var v = A.sdkErrorAreaString(n);
                d += ":" + (c.error_area = v);
                var g = A.sdkErrorActionString(t);
                c.error_action = g;
                var f = A.sdkErrorParameterString(i);
                if (0 < f.length && (c.error_parameter = f), 0 < r.length) {
                    var m = r;
                    r.length > A.MAX_ERROR_MESSAGE_LENGTH && (m = r.substring(0, A.MAX_ERROR_MESSAGE_LENGTH)), c.reason = m
                }
                var p = [];
                p.push(c), (o = JSON.stringify(p)) ? y.execute(u, d, o, a) : S.w("sendSdkErrorEvent: JSON encoding failed.")
            }
        }, A.sendEventInArrayRequestCallback = function(e, n, t, i) {
            void 0 === i && (i = null), i[0], i[1];
            var r, s, a = i[2],
                o = parseInt(i[3]);
            r = e.responseText, s = e.status;
            var u = A.instance.processRequestResponse(s, e.statusText, r, "Events");
            if (u == c.EGAHTTPApiResponse.Ok || u == c.EGAHTTPApiResponse.Created || u == c.EGAHTTPApiResponse.BadRequest) {
                var d = r ? JSON.parse(r) : {};
                if (null == d) return t(c.EGAHTTPApiResponse.JsonDecodeFailed, null, a, o), void A.instance.sendSdkErrorEvent(v.Http, g.EventsHttp, f.FailHttpJsonDecode, m.Undefined, r, E.getGameKey(), E.getGameSecret());
                c.EGAHTTPApiResponse.BadRequest, t(u, d, a, o)
            } else t(u, null, a, o)
        }, A.sendRequest = function(e, n, t, i, r, s) {
            var a = new XMLHttpRequest,
                o = E.getGameSecret(),
                u = l.getHmac(o, n),
                d = [];
            for (var c in d.push(u), t) d.push(t[c]);
            if (a.onreadystatechange = function() {
                    4 === a.readyState && r(a, e, s, d)
                }, a.open("POST", e, !0), a.setRequestHeader("Content-Type", "application/json"), a.setRequestHeader("Authorization", u), i) throw new Error("gzip not supported");
            try {
                a.send(n)
            } catch (e) {
                console.error(e.stack)
            }
        }, A.initRequestCallback = function(e, n, t, i) {
            var r, s;
            void 0 === i && (i = null), i[0], i[1], r = e.responseText, s = e.status;
            var a = r ? JSON.parse(r) : {},
                o = A.instance.processRequestResponse(s, e.statusText, r, "Init");
            if (o == c.EGAHTTPApiResponse.Ok || o == c.EGAHTTPApiResponse.Created || o == c.EGAHTTPApiResponse.BadRequest) {
                if (null == a) return t(c.EGAHTTPApiResponse.JsonDecodeFailed, null, "", 0), void A.instance.sendSdkErrorEvent(v.Http, g.InitHttp, f.FailHttpJsonDecode, m.Undefined, r, E.getGameKey(), E.getGameSecret());
                if (o !== c.EGAHTTPApiResponse.BadRequest) {
                    var u = h.validateAndCleanInitRequestResponse(a, o === c.EGAHTTPApiResponse.Created);
                    u ? t(o, u, "", 0) : t(c.EGAHTTPApiResponse.BadResponse, null, "", 0)
                } else t(o, null, "", 0)
            } else t(o, null, "", 0)
        }, A.prototype.createPayloadData = function(e, n) {
            if (n) throw new Error("gzip not supported");
            return e
        }, A.prototype.processRequestResponse = function(e, n, t, i) {
        ...
        }, A.sdkErrorCategoryString = function(e) {
            switch (e) {
            ...
            return ""
        }, A.sdkErrorAreaString = function(e) {
            switch (e) {
            ...
            return ""
        }, A.sdkErrorActionString = function(e) {
            switch (e) {
            ...
            return ""
        }, A.sdkErrorParameterString = function(e) {
            switch (e) {
                case m.Currency:
                    return "currency";
                case m.CartType:
            ...
            return ""
        }, A.instance = new A, A.MAX_ERROR_MESSAGE_LENGTH = 256, n = A, c.GAHTTPApi = n
    }(gameanalytics = gameanalytics || {}),
    function(v) {
        var g, f, m, p, E, S, h, d, y, A, e;

        function C() {}
        g = v.events || (v.events = {}), f = v.store.GAStore, m = v.store.EGAStore, p = v.store.EGAStoreArgsOperator, E = v.state.GAState, S = v.logging.GALogger, h = v.utilities.GAUtilities, d = v.http.EGAHTTPApiResponse, y = v.http.GAHTTPApi, A = v.validators.GAValidator, C.addSessionStartEvent = function() {
            if (E.isEventSubmissionEnabled()) {
                var e = {};
                e.category = C.CategorySessionStart, E.incrementSessionNum(), f.setItem(E.getGameKey(), E.SessionNumKey, E.getSessionNum().toString()), C.addDimensionsToEvent(e), C.addEventToStore(e), S.i("Add SESSION START event"), C.processEvents(C.CategorySessionStart, !1)
            }
        }, C.addSessionEndEvent = function() {
            if (E.isEventSubmissionEnabled()) {
                var e = E.getSessionStart(),
                    n = E.getClientTsAdjusted() - e;
            ...
            if (void 0 === r && (r = null), E.isEventSubmissionEnabled()) {
                var a = A.validateBusinessEvent(e, n, r, t, i);
                if (null == a) {
                    var o = {};
                    E.incrementTransactionNum(), f.setItem(E.getGameKey(), E.TransactionNumKey, E.getTransactionNum().toString()), o.event_id = t + ":" + i, o.category = C.CategoryBusiness, o.currency = e, o.amount = n, o[E.TransactionNumKey] = E.getTransactionNum(), r && (o.cart_type = r), C.addDimensionsToEvent(o), C.addFieldsToEvent(o, E.validateAndCleanCustomFields(s)), S.i("Add BUSINESS event: {currency:" + e + ", amount:" + n + ", itemType:" + t + ", itemId:" + i + ", cartType:" + r + "}"), C.addEventToStore(o)
                } else y.instance.sendSdkErrorEvent(a.category, a.area, a.action, a.parameter, a.reason, E.getGameKey(), E.getGameSecret())
            }
        }, C.addResourceEvent = function(e, n, t, i, r, s) {
            if (E.isEventSubmissionEnabled()) {
                var a = A.validateResourceEvent(e, n, t, i, r, E.getAvailableResourceCurrencies(), E.getAvailableResourceItemTypes());
                if (null == a) {
                    e === v.EGAResourceFlowType.Sink && (t *= -1);
                    var o = {},
                        u = C.resourceFlowTypeToString(e);
                    o.event_id = u + ":" + n + ":" + i + ":" + r, o.category = C.CategoryResource, o.amount = t, C.addDimensionsToEvent(o), C.addFieldsToEvent(o, E.validateAndCleanCustomFields(s)), S.i("Add RESOURCE event: {currency:" + n + ", amount:" + t + ", itemType:" + i + ", itemId:" + r + "}"), C.addEventToStore(o)
                } else y.instance.sendSdkErrorEvent(a.category, a.area, a.action, a.parameter, a.reason, E.getGameKey(), E.getGameSecret())
            }
        }, C.addProgressionEvent = function(e, n, t, i, r, s, a) {
            if (E.isEventSubmissionEnabled()) {
                var o = C.progressionStatusToString(e),
                    u = A.validateProgressionEvent(e, n, t, i);
                if (null == u) {
                    var d, c = {};
                    d = t ? i ? n + ":" + t + ":" + i : n + ":" + t : n, c.category = C.CategoryProgression, c.event_id = o + ":" + d;
                    var l = 0;
                    s && e != v.EGAProgressionStatus.Start && (c.score = r), e === v.EGAProgressionStatus.Fail && E.incrementProgressionTries(d), e === v.EGAProgressionStatus.Complete && (E.incrementProgressionTries(d), l = E.getProgressionTries(d), c.attempt_num = l, E.clearProgressionTries(d)), C.addDimensionsToEvent(c), C.addFieldsToEvent(c, E.validateAndCleanCustomFields(a)), S.i("Add PROGRESSION event: {status:" + o + ", progression01:" + n + ", progression02:" + t + ", progression03:" + i + ", score:" + r + ", attempt:" + l + "}"), C.addEventToStore(c)
                } else y.instance.sendSdkErrorEvent(u.category, u.area, u.action, u.parameter, u.reason, E.getGameKey(), E.getGameSecret())
            }
        }, C.addDesignEvent = function(e, n, t, i) {
            if (E.isEventSubmissionEnabled()) {
                var r = A.validateDesignEvent(e);
                if (null == r) {
                    var s = {};
                    s.category = C.CategoryDesign, s.event_id = e, t && (s.value = n), C.addDimensionsToEvent(s), C.addFieldsToEvent(s, E.validateAndCleanCustomFields(i)), S.i("Add DESIGN event: {eventId:" + e + ", value:" + n + "}"), C.addEventToStore(s)
                } else y.instance.sendSdkErrorEvent(r.category, r.area, r.action, r.parameter, r.reason, E.getGameKey(), E.getGameSecret())
            }
        }, C.addErrorEvent = function(e, n, t) {
            if (E.isEventSubmissionEnabled()) {
                var i = C.errorSeverityToString(e),
                    r = A.validateErrorEvent(e, n);
                if (null == r) {
                    var s = {};
                    s.category = C.CategoryError, s.severity = i, s.message = n, C.addDimensionsToEvent(s), C.addFieldsToEvent(s, E.validateAndCleanCustomFields(t)), S.i("Add ERROR event: {severity:" + i + ", message:" + n + "}"), C.addEventToStore(s)
                } else y.instance.sendSdkErrorEvent(r.category, r.area, r.action, r.parameter, r.reason, E.getGameKey(), E.getGameSecret())
            }
        }, C.processEvents = function(e, n) {
            if (E.isEventSubmissionEnabled()) try {
                var t = h.createGuid();
                ...
                for (var u = [], d = 0; d < a.length; ++d) {
                    var c = a[d],
                        l = JSON.parse(h.decode64(c.event));
                    0 != l.length && u.push(l)
                }
                y.instance.sendEventsInArray(u, t, C.processEventsCallback)
            } catch (e) {
                S.e("Error during ProcessEvents(): " + e.stack), y.instance.sendSdkErrorEvent(g.EGASdkErrorCategory.Json, g.EGASdkErrorArea.ProcessEvents, g.EGASdkErrorAction.JsonError, g.EGASdkErrorParameter.Undefined, e.stack, E.getGameKey(), E.getGameSecret())
            }
        }, C.processEventsCallback = function(e, n, t, i) {
            var r = [];
            if (r.push(["status", p.Equal, t]), e === d.Ok) f.delete(m.Events, r), S.i("Event queue: " + i + " events sent.");
                ...
                if (n) {
                    var a, o = 0;
                    for (var u in n) 0 == o && (a = n[u]), ++o;
                    e === d.BadRequest && a.constructor === Array ? S.w("Event queue: " + i + " events sent. " + o + " events failed GA server validation.") : S.w("Event queue: Failed to send events.")
            ...
            if (E.isEventSubmissionEnabled()) {
                var e = [];
                e.push(["session_id", p.NotEqual, E.getSessionId()]);
            ...
            if (E.isEventSubmissionEnabled())
                if (E.isInitialized()) try {
                    if (f.isStoreTooLargeForEvents() && !h.stringMatch(e.category, /^(user|session_end|business)$/)) return S.w("Database too large. Event has been blocked."), void y.instance.sendSdkErrorEvent(g.EGASdkErrorCategory.Database, g.EGASdkErrorArea.AddEventsToStore, g.EGASdkErrorAction.DatabaseTooLarge, g.EGASdkErrorParameter.Undefined, "", E.getGameKey(), E.getGameSecret());
                    var n = E.getEventAnnotations(),
                    ...
                    s.category = n.category, s.session_id = n.session_id, s.client_ts = n.client_ts, s.event = h.encode64(JSON.stringify(n)), f.insert(m.Events, s), e.category == C.CategorySessionEnd ? f.delete(m.Sessions, [
                        ["session_id", p.Equal, n.session_id]
                    ]) : ((s = {}).session_id = n.session_id, s.timestamp = E.getSessionStart(), s.event = t, f.insert(m.Sessions, s, !0, "session_id")), f.isStorageAvailable() && f.save(E.getGameKey())
                } catch (i) {
                    S.e("addEventToStore: error"), S.e(i.stack), y.instance.sendSdkErrorEvent(g.EGASdkErrorCategory.Database, g.EGASdkErrorArea.AddEventsToStore, g.EGASdkErrorAction.DatabaseTooLarge, g.EGASdkErrorParameter.Undefined, i.stack, E.getGameKey(), E.getGameSecret())
                } else S.w("Could not add event: SDK is not initialized")
        }, C.updateSessionStore = function() {
            if (E.sessionIsStarted()) {
                var e = {};
                e.session_id = E.instance.sessionId, e.timestamp = E.getSessionStart(), e.event = h.encode64(JSON.stringify(E.getEventAnnotations())), f.insert(m.Sessions, e, !0, "session_id"), f.isStorageAvailable() && f.save(E.getGameKey())
            }
        }, C.addDimensionsToEvent = function(e) {
            e && (E.getCurrentCustomDimension01() && (e.custom_01 = E.getCurrentCustomDimension01()), E.getCurrentCustomDimension02() && (e.custom_02 = E.getCurrentCustomDimension02()), E.getCurrentCustomDimension03() && (e.custom_03 = E.getCurrentCustomDimension03()))
        }, C.addFieldsToEvent = function(e, n) {
            e && n && 0 < Object.keys(n).length && (e.custom_fields = n)
        }, C.resourceFlowTypeToString = function(e) {
            return e == v.EGAResourceFlowType.Source || e == v.EGAResourceFlowType[v.EGAResourceFlowType.Source] ? "Source" : e == v.EGAResourceFlowType.Sink || e == v.EGAResourceFlowType[v.EGAResourceFlowType.Sink] ? "Sink" : ""
        }, C.progressionStatusToString = function(e) {
            return e == v.EGAProgressionStatus.Start || e == v.EGAProgressionStatus[v.EGAProgressionStatus.Start] ? "Start" : e == v.EGAProgressionStatus.Complete || e == v.EGAProgressionStatus[v.EGAProgressionStatus.Complete] ? "Complete" : e == v.EGAProgressionStatus.Fail || e == v.EGAProgressionStatus[v.EGAProgressionStatus.Fail] ? "Fail" : ""
        }, C.errorSeverityToString = function(e) {
            return e == v.EGAErrorSeverity.Debug || e == v.EGAErrorSeverity[v.EGAErrorSeverity.Debug] ? "debug" : e == v.EGAErrorSeverity.Info || e == v.EGAErrorSeverity[v.EGAErrorSeverity.Info] ? "info" : e == v.EGAErrorSeverity.Warning || e == v.EGAErrorSeverity[v.EGAErrorSeverity.Warning] ? "warning" : e == v.EGAErrorSeverity.Error || e == v.EGAErrorSeverity[v.EGAErrorSeverity.Error] ? "error" : e == v.EGAErrorSeverity.Critical || e == v.EGAErrorSeverity[v.EGAErrorSeverity.Critical] ? "critical" : ""
        }, C.CategorySessionStart = "user", C.CategorySessionEnd = "session_end", C.CategoryDesign = "design", C.CategoryBusiness = "business", C.CategoryProgression = "progression", C.CategoryResource = "resource", C.CategoryError = "error", C.MaxEventCount = 500, e = C, g.GAEvents = e
    }(gameanalytics = gameanalytics || {}),
    function(e) {
        var r, n, t, i, s;
        ...
        var o = a.threading.GAThreading,
            ...
            n = (m.init = function() {
                ...
                void 0 === e && (e = []), o.performTaskOnGAThread(function() {
                    m.isSdkReady(!0, !1) ? u.w("Available custom dimensions must be set before SDK is initialized") : c.setAvailableCustomDimensions01(e)
                })
            }, m.configureAvailableCustomDimensions02 = function(e) {
                void 0 === e && (e = []), o.performTaskOnGAThread(function() {
                    m.isSdkReady(!0, !1) ? u.w("Available custom dimensions must be set before SDK is initialized") : c.setAvailableCustomDimensions02(e)
                })
            }, m.configureAvailableCustomDimensions03 = function(e) {
                void 0 === e && (e = []), o.performTaskOnGAThread(function() {
                    m.isSdkReady(!0, !1) ? u.w("Available custom dimensions must be set before SDK is initialized") : c.setAvailableCustomDimensions03(e)
                })
            }, m.configureAvailableResourceCurrencies = function(e) {
                void 0 === e && (e = []), o.performTaskOnGAThread(function() {
                    m.isSdkReady(!0, !1) ? u.w("Available resource currencies must be set before SDK is initialized") : c.setAvailableResourceCurrencies(e)
                })
            }, m.configureAvailableResourceItemTypes = function(e) {
                void 0 === e && (e = []), o.performTaskOnGAThread(function() {
                    m.isSdkReady(!0, !1) ? u.w("Available resource item types must be set before SDK is initialized") : c.setAvailableResourceItemTypes(e)
                })
            }, m.configureBuild = function(e) {
                void 0 === e && (e = ""), o.performTaskOnGAThread(function() {
                    m.isSdkReady(!0, !1) ? u.w("Build version must be set before SDK is initialized.") : i.validateBuild(e) ? c.setBuild(e) : u.i("Validation fail - configure build: Cannot be null, empty or above 32 length. String: " + e)
                })
            }, m.configureSdkGameEngineVersion = function(e) {
                void 0 === e && (e = ""), o.performTaskOnGAThread(function() {
                    m.isSdkReady(!0, !1) || (i.validateSdkWrapperVersion(e) ? l.sdkGameEngineVersion = e : u.i("Validation fail - configure sdk version: Sdk version not supported. String: " + e))
                })
            }, m.configureGameEngineVersion = function(e) {
                void 0 === e && (e = ""), o.performTaskOnGAThread(function() {
                    m.isSdkReady(!0, !1) || (i.validateEngineVersion(e) ? l.gameEngineVersion = e : u.i("Validation fail - configure game engine version: Game engine version not supported. String: " + e))
                })
            }, m.configureUserId = function(e) {
                void 0 === e && (e = ""), o.performTaskOnGAThread(function() {
                    m.isSdkReady(!0, !1) ? u.w("A custom user id must be set before SDK is initialized.") : i.validateUserId(e) ? c.setUserId(e) : u.i("Validation fail - configure user_id: Cannot be null, empty or above 64 length. Will use default user_id method. Used string: " + e)
                })
                ...
                t.async = !0, m.initTimedBlockId = t.id, t.block = function() {
                    m.isSdkReady(!0, !1) ? u.w("SDK already initialized. Can only be called once.") : i.validateKeys(e, n) ? (c.setKeys(e, n), m.internalInitialize()) : u.w("SDK failed initialize. Game key or secret key is invalid. Can only contain characters A-z 0-9, gameKey is 32 length, gameSecret is 40 length. Failed keys - gameKey: " + e + ", secretKey: " + n)
                ...
                void 0 === e && (e = !1), o.performTaskOnGAThread(function() {
                    e ? (u.setInfoLog(e), u.i("Info logging enabled")) : (u.i("Info logging disabled"), u.setInfoLog(e))
                })
            }, m.setEnabledVerboseLog = function(e) {
                void 0 === e && (e = !1), o.performTaskOnGAThread(function() {
                    e ? (u.setVerboseLog(e), u.i("Verbose logging enabled")) : (u.i("Verbose logging disabled"), u.setVerboseLog(e))
                })
                ...
                void 0 === e && (e = !1), o.performTaskOnGAThread(function() {
                    e ? (c.setEnabledEventSubmission(e), u.i("Event submission enabled")) : (u.i("Event submission disabled"), c.setEnabledEventSubmission(e))
                })
            }, m.setCustomDimension01 = function(e) {
                void 0 === e && (e = ""), o.performTaskOnGAThread(function() {
                    i.validateDimension01(e, c.getAvailableCustomDimensions01()) ? c.setCustomDimension01(e) : u.w("Could not set custom01 dimension value to '" + e + "'. Value not found in available custom01 dimension values")
                })
            }, m.setCustomDimension02 = function(e) {
                void 0 === e && (e = ""), o.performTaskOnGAThread(function() {
                    i.validateDimension02(e, c.getAvailableCustomDimensions02()) ? c.setCustomDimension02(e) : u.w("Could not set custom02 dimension value to '" + e + "'. Value not found in available custom02 dimension values")
                })
            }, m.setCustomDimension03 = function(e) {
                void 0 === e && (e = ""), o.performTaskOnGAThread(function() {
                    i.validateDimension03(e, c.getAvailableCustomDimensions03()) ? c.setCustomDimension03(e) : u.w("Could not set custom03 dimension value to '" + e + "'. Value not found in available custom03 dimension values")
                })
                ...
                c.ensurePersistedStates(), d.setItem(c.getGameKey(), c.DefaultUserIdKey, c.getDefaultId()), c.setInitialized(!0), m.newSession(), c.isEnabled() && o.ensureEventQueueIsRunning()
            }, m.newSession = function() {
                u.i("Starting a new session."), c.validateAndFixCurrentDimensions(), e.instance.requestInit(c.instance.configsHash, m.startNewSessionCallback)
            }, m.startNewSessionCallback = function(e, n) {
                if (e !== v.Ok && e !== v.Created || !n) e == v.Unauthorized ? (u.w("Initialize SDK failed - Unauthorized"), c.instance.initAuthorized = !1) : (e === v.NoResponse || e === v.RequestTimeout ? u.i("Init call (session start) failed - no response. Could be offline or timeout.") : e === v.BadResponse || e === v.JsonEncodeFailed || e === v.JsonDecodeFailed ? u.i("Init call (session start) failed - bad response. Could be bad response from proxy or GA servers.") : e !== v.BadRequest && e !== v.UnknownResponseCode || u.i("Init call (session start) failed - bad request or unknown response."), null == c.instance.sdkConfig ? null != c.instance.sdkConfigCached ? (u.i("Init call (session start) failed - using cached init values."), c.instance.sdkConfig = c.instance.sdkConfigCached) : (u.i("Init call (session start) failed - using default init values."), c.instance.sdkConfig = c.instance.sdkConfigDefault) : u.i("Init call (session start) failed - using cached init values."), c.instance.initAuthorized = !0);
                else {
                    var t = 0;
                    if (n.server_ts) {
                        var i = n.server_ts;
                    ...
                    c.instance.configsHash = n.configs_hash ? n.configs_hash : "", c.instance.abId = n.ab_id ? n.ab_id : "", c.instance.abVariantId = n.ab_variant_id ? n.ab_variant_id : "", d.setItem(c.getGameKey(), c.SdkConfigCachedKey, g.encode64(JSON.stringify(n))), c.instance.sdkConfigCached = n, c.instance.sdkConfig = n, c.instance.initAuthorized = !0
                }
                if (c.instance.clientServerTimeOffset = c.getSdkConfig().time_offset ? c.getSdkConfig().time_offset : 0, c.populateConfigurations(c.getSdkConfig()), !c.isEnabled()) return u.w("Could not start session: SDK is disabled."), void o.stopEventQueue();
                ...
                c.isInitialized() && (u.i("Resuming session."), c.sessionIsStarted() || m.newSession())
            }, m.isSdkReady = function(e, n, t) {
                return void 0 === n && (n = !0), void 0 === t && (t = ""), t && (t += ": "), e && !c.isInitialized() ? (n && u.w(t + "SDK is not initialized"), !1) : e && !c.isEnabled() ? (n && u.w(t + "SDK is disabled"), !1) : !(e && !c.sessionIsStarted() && (n && u.w(t + "Session has not started yet"), 1))
