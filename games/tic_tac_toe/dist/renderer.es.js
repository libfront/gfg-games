function a(t, o) {
  ...
  if (!(typeof document > "u")) {
    var i = document.head || document.getElementsByTagName("head")[0], e = document.createElement("style");
    e.type = "text/css", r === "top" && i.firstChild ? i.insertBefore(e, i.firstChild) : i.appendChild(e), e.styleSheet ? e.styleSheet.cssText = t : e.appendChild(document.createTextNode(t));
  }
}
...
a(n);
const s = async (t) => ({
  set: async (o, r) => (console.log(`--renderer [${o.data.curr.type}]`), console.log(t.f.path("")), {
    r: `
