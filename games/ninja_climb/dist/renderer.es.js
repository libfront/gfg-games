function a(i, t) {
  ...
  if (!(!i || typeof document > "u")) {
    ...
    o.type = "text/css", n === "top" && e.firstChild ? e.insertBefore(o, e.firstChild) : e.appendChild(o), o.styleSheet ? o.styleSheet.cssText = i : o.appendChild(document.createTextNode(i));
  }
}
